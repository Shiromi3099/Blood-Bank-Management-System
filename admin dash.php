...
$sql = "SELECT COUNT(*) AS total_recipient FROM recipient";
$result = $conn->query($sql);

if ($result && $result->num_rows > 0) {
    // Fetch the total number of donors
    $row = $result->fetch_assoc();
    $total_recipient = $row['total_recipient'];
} else {
    $total_donors = 0;
}
        ...
        <div class="content">
            ...
            <nav class="navbar navbar-expand bg-light navbar-light sticky-top px-4 py-0">
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <span class="d-none d-lg-inline-flex">Rajapaksha</span>
                        </a>
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">
            ...
            <div class="container-fluid pt-4 px-4">
                ...
                <div class="col-sm-6 col-xl-3">
                  <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                     <div class="ms-3">
                       ...
                       <p class="mb-2"><?php echo $total_donors; ?></p>
                     </div>
                  </div>
                </div>
                ...
                <div class="col-sm-6 col-xl-3">
                  <div class="bg-light rounded d-flex align-items-center justify-content-between p-4">
                     <div class="ms-3">
                       <h6 class="mb-0">Total Donors</h6>
                       <p class="mb-2"><?php echo $total_recipient; ?></p>
                     </div>
                  </div>
                </div>
                </div>
